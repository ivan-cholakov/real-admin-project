...
import TrailFile from '../../../../../pageWidgets/Files/Trail';
...
const mdtp = (dispatch) => ({
    handleTrailSubmit: (product) => () => {
        dispatch(push(`/assets/products/${product.id}/stockists`));
    },
...
const mp = (stateProps, dispatchProps) => ({
    ...
    handleTrailSubmit: dispatchProps.handleTrailSubmit(stateProps.product)
