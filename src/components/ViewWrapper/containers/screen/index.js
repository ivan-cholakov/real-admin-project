...
import { selectCompany, setSelectedCompany } from '../../../../store/common/companies/actions';
...
export default connect(mapStateToProps, mapDispatchToProps, mergeProps)(ViewWrapper);
